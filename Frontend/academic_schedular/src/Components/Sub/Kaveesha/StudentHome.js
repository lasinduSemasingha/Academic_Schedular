    ...
    return (
        <Container maxWidth="lg">
            ...
            <Box sx={{ textAlign: 'center', my: 4 }}>
                <Typography variant="h5" sx={{ fontSize: '35px', fontWeight: 'bold', mb: 1 }}>Student Management</Typography>
                    ...
                    <Grid item xs={12} md={4}>
                        <Card sx={{ boxShadow: 3, textAlign: 'center', p: 2 }}>
                            <CardContent>
                                ...
                                {/* Inactive Students Progress Bar */}
            ...
            <Grid item xs={12} sm={6} md={4} key={index}>
                ...
                >
                    <CardContent>
                        ...
                        <Typography variant="body2" sx={{ fontStyle: 'italic', mt: 1 }}>Date: {event.date}</Typography>
                    </CardContent>
                </Card>
            </Grid>
        ))}
